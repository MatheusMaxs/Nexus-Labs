  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 group">
      <button
        ...
        className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-xl shadow-lg nexus-transition hover:scale-105"
      ...
      <div className="absolute bottom-full right-0 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        <div className="bg-green-500 text-white px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap shadow-lg">
          Fale conosco!
